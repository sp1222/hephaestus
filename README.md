...
Container images for homelab use, automatically built and pushed to ghcr.io via GitHub Actions.

## Images

### ollama-rocm-gfx-1010
...
Or with docker-compose (see `ollama-rocm/docker-compose.yml`):
```bash
docker compose -f ollama-rocm/docker-compose.yml up -d
```
